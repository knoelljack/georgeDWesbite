    ...
    <>
        <Container fluid style={{backgroundColor : "black"}}>
            <Row>
                ...
                <Col style={colStyle}>
                    <p style={paragraphStyle}>George Dulcich is a Los Angeles based comedian born and raised in Glendale, California. He began his stand-up career in New York City in 2019 but returned to Los Angeles “after things went to crap” at the onset of the pandemic. <br></br><br></br>
